...
<div class="row">
    <div class="col-xl-6 card mb-4 mt-5">
        ...
        <div class="card-body"><canvas id="detailLansiaChart" width="100%" height="40"></canvas></div>
    </div>
</div>
<!-- END CHART -->
    ...
    <div class="card-body">
        <table id="datatablesSimple">
            ...
            <tbody>
                <?php
                    $id = $_GET['id'];
                    $api = file_get_contents("https://api.posyandu.niwabi.my.id/elderly/detail?elderly_id={$id}");
                    ...
                    if($dump > 0) {
                        ...
                        ?>  
                            <tr>
                                ...
                                <td><?php echo $json['data'][$x]['waist_size']; ?></td>
